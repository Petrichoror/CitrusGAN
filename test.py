...
#   parse.add_argument('--data', type=str, default='LIDC256', dest='data',
#                      help='input data ')
#   parse.add_argument('--tag', type=str, default='d2_multiview2500', dest='tag',
#                      help='distinct from other try')
#   parse.add_argument('--dataroot', type=str, default='./data/LIDC-HDF5-256', dest='dataroot',
...
#   parse.add_argument('--ymlpath', type=str, default='./experiment/multiview2500/d2_multiview2500.yml', dest='ymlpath',
#                      help='config have been modified')
#   parse.add_argument('--gpu', type=str, default='0', dest='gpuid',
#                      help='gpu is split by ,')
#   parse.add_argument('--dataset_class', type=str, default='align_ct_xray_4views_std', dest='dataset_class',
#                      help='Dataset class should select from unalign /')
#   parse.add_argument('--model_class', type=str, default='FourViewCTGAN', dest='model_class',
...
#   parse.add_argument('--how_many', type=int, dest='how_many', default="106",
#                      help='if specified, only run this number of test samples for visualization')
#   parse.add_argument('--resultdir', type=str, default='./fourviewfused-way2（5-1）', dest='resultdir',
...
def parse_args():
  ...
  parse.add_argument('--gpu', type=str, default='0', dest='gpuid',
                     help='gpu is split by ,')
  parse.add_argument('--dataset_class', type=str, default='align_ct_xray_views', dest='dataset_class',
                     help='Dataset class should select from unalign /')
  ...
  parse.add_argument('--how_many', type=int, dest='how_many', default="106",
                     help='if specified, only run this number of test samples for visualization')
  parse.add_argument('--resultdir', type=str, default='./YUNNANMultiViewCTGAN(5-1)', dest='resultdir',
                     help='dir to save result')
  args = parse.parse_args()
  return args
# #
...
#   parse.add_argument('--gpu', type=str, default='0', dest='gpuid',
#                      help='gpu is split by ,')
#   parse.add_argument('--dataset_class', type=str, default='align_ct_xray_6views_std', dest='dataset_class',
#                      help='Dataset class should select from unalign /')
#   parse.add_argument('--model_class', type=str, default='SixViewCTGAN', dest='model_class',
#                      help='Model class should select from cyclegan / ')
#   parse.add_argument('--check_point', type=str, default='100', dest='check_point',
#                      help='which epoch to load? ')
#   parse.add_argument('--latest', action='store_true', dest='latest',
...
#   parse.add_argument('--load_path', type=str, default=None, dest='load_path',
#                      help='if load_path is not None, model will load from load_path')
#   parse.add_argument('--how_many', type=int, dest='how_many', default="10",
#                      help='if specified, only run this number of test samples for visualization')
#   parse.add_argument('--resultdir', type=str, default='./SixviewALL10632', dest='resultdir',
#                      help='dir to save result')
#   args = parse.parse_args()
#   return args
...
def evaluate(args):
  ...
  for epoch_i, data in tqdm.tqdm(enumerate(dataloader)):
    ...
    real_CT_transpose = tensor_back_to_unMinMax(real_CT_transpose, opt.CT_MIN_MAX[0], opt.CT_MIN_MAX[1]).astype(
      np.int32)
    psnr_3d = Peak_Signal_to_Noise_Rate_3D(real_CT_transpose, generate_CT_transpose, size_average=False, PIXEL_MAX=60167)
    psnr = Peak_Signal_to_Noise_Rate(real_CT_transpose, generate_CT_transpose, size_average=False, PIXEL_MAX=60167)
