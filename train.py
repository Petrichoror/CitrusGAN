...
#     parse.add_argument('--valid_dataset', type=str, default='测试', dest='valid_dataset',
#                        help='Train or test or valid')
...
if __name__ == '__main__':
    ...
    for epoch in range(opt.epoch_count, opt.niter + opt.niter_decay + 1):
      ...
      '''
        ...
        ######### For speed #########
        # visualizer.add_image('Image_Epoch', gan_model.get_current_visuals(),
        # gan_model.get_normalization_list(), epoch)
        ...
        #       gan_model.test()
        #
        # if v_i < opt.howmany_in_train: visualizer.add_image('Test_Image', gan_model.get_current_visuals(),
        # gan_model.get_normalization_list(), epoch*10+v_i, max_image=25)
        #
        #       # metrics
        #       metrics_dict = gan_model.get_current_metrics()
