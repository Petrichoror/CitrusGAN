...
class CTGAN(Base_Model):
  ...
  def init_network(self, opt):
    ...
    self.visual_names = ['G_real', 'G_fake', 'G_input1', 'G_input2', 'G_input3', 'G_input4','G_input5','G_input6', 'G_Map_fake_F', 'G_Map_real_F', 'G_Map_fake_S', 'G_Map_real_S']
    ...
    if self.training:
      ...
      if self.conditional_D:
        d_input_channels = opt.input_nc_D + 6
      else:
  ...
  def get_normalization_list(self):
    return [
      ...
      [self.opt.XRAY3_MEAN_STD[0], self.opt.XRAY3_MEAN_STD[1]],
      [self.opt.XRAY4_MEAN_STD[0], self.opt.XRAY4_MEAN_STD[1]],
      [self.opt.XRAY5_MEAN_STD[0], self.opt.XRAY5_MEAN_STD[1]],
      [self.opt.XRAY6_MEAN_STD[0], self.opt.XRAY6_MEAN_STD[1]],
      [self.opt.CT_MEAN_STD[0], self.opt.CT_MEAN_STD[1]],
      [self.opt.CT_MEAN_STD[0], self.opt.CT_MEAN_STD[1]],
      [self.opt.CT_MEAN_STD[0], self.opt.CT_MEAN_STD[1]],
      [self.opt.CT_MEAN_STD[0], self.opt.CT_MEAN_STD[1]]
  ...
  def set_input(self, input):
    ...
    self.G_input3 = input[1][2].to(self.device)  # 新增的输入数据
    self.G_input4 = input[1][3].to(self.device)
    self.G_input5 = input[1][4].to(self.device)
    self.G_input6 = input[1][5].to(self.device)
  ...
  def forward(self):
    ...
    self.G_fake_D1, self.G_fake_D2, self.G_fake_D3,self.G_fake_D4,self.G_fake_D5,self.G_fake_D6, self.G_fake_D = self.netG([self.G_input1, self.G_input2,self.G_input3,self.G_input4,self.G_input5,self.G_input6])
    ...
    if self.auxiliary_loss and self.training:
      ...
      self.G_real_D4 = self.G_real_D.permute(*self.opt.CTOrder_Xray4).detach()
      self.G_real_D5 = self.G_real_D.permute(*self.opt.CTOrder_Xray5).detach()
      self.G_real_D6 = self.G_real_D.permute(*self.opt.CTOrder_Xray6).detach()
    ...
    if self.conditional_D and self.training:
      self.G_condition_D = torch.cat((
        ...
        self.dimension_order_std(self.G_input3.unsqueeze(1).expand_as(self.G_real_D), self.opt.CTOrder_Xray3),
        self.dimension_order_std(self.G_input4.unsqueeze(1).expand_as(self.G_real_D), self.opt.CTOrder_Xray4),
        self.dimension_order_std(self.G_input5.unsqueeze(1).expand_as(self.G_real_D), self.opt.CTOrder_Xray5),
        self.dimension_order_std(self.G_input6.unsqueeze(1).expand_as(self.G_real_D), self.opt.CTOrder_Xray6)
      ), dim=1).detach()
  ...
  def backward_G(self):
    ...
    if self.auxiliary_loss:
      self.loss_auxiliary = (self.criterionAuxiliary(self.G_fake_D1, self.G_real_D1) +
                             ...
                             self.criterionAuxiliary(self.G_fake_D4, self.G_real_D4) +
                             self.criterionAuxiliary(self.G_fake_D5, self.G_real_D5) +
                             self.criterionAuxiliary(self.G_fake_D6, self.G_real_D6)) * \
