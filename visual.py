...
def parse_args():
  ...
  parse.add_argument('--how_many', type=int, dest='how_many', default="106",
                     help='if specified, print more debugging information')
  parse.add_argument('--resultdir', type=str, default='./YUNNANcontrast_Two_20-45', dest='resultdir',
...
#   parse.add_argument('--data', type=str, default='LIDC256', dest='data',
#                      help='input data ')
#   parse.add_argument('--tag', type=str, default='d2_singleview2500', dest='tag',
#                      help='distinct from other try')
#   parse.add_argument('--dataroot', type=str, default='./data/LIDC-HDF5-256', dest='dataroot',
#                      help='input data root')
#   parse.add_argument('--dataset', type=str, default='test', dest='dataset',
...
#   parse.add_argument('--datasetfile', type=str, default='./data/test.txt', dest='datasetfile',
#                      help='Train or test or valid file path')
#   parse.add_argument('--ymlpath', type=str, default='./experiment/singleview2500/d2_singleview2500.yml', dest='ymlpath',
#                      help='config have been modified')
#   parse.add_argument('--gpu', type=str, default='0', dest='gpuid',
#                      help='gpu is split by ,')
#   parse.add_argument('--dataset_class', type=str, default='align_ct_xray_std', dest='dataset_class',
#                      help='Dataset class should select from unalign /')
#   parse.add_argument('--model_class', type=str, default='SingleViewCTGAN', dest='model_class',
#                      help='Model class should select from cyclegan / ')
#   parse.add_argument('--check_point', type=str, default='100', dest='check_point',
#                      help='which epoch to load? ')
#   parse.add_argument('--latest', action='store_true', dest='latest',
...
#   parse.add_argument('--load_path', type=str, default=None, dest='load_path',
#                      help='if load_path is not None, model will load from load_path')
#   parse.add_argument('--how_many', type=int, dest='how_many', default="3",
#                      help='if specified, print more debugging information')
#   parse.add_argument('--resultdir', type=str, default='./singleview', dest='resultdir',
#                      help='dir to save result')
#   args = parse.parse_args()
#   return args
#
...
#   parse.add_argument('--how_many', type=int, dest='how_many', default="106",
#                      help='if specified, print more debugging information')
#   parse.add_argument('--resultdir', type=str, default='./fourviewfused-way2', dest='resultdir',
#                      help='dir to save result')
#   args = parse.parse_args()
#   return args
